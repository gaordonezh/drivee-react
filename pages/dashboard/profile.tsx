      ...
      <div className="flex flex-col items-center gap-5">
        ...
        <List
          ...
          data={[
            ...
            { title: 'Tipo documento', value: edit ? <Input sizes="small" /> : fields.t_doc ?? defaultText },
            { title: 'Nro documento', value: edit ? <Input sizes="small" /> : fields.n_doc ?? defaultText },
            ...
            { title: 'Dirección', value: edit ? <Input sizes="small" /> : fields.address?.address ?? defaultText },
          ]}
        />
